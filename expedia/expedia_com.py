...
class ExpediaCOM:
    ...
    def __init__(self):
        print('Extracción de expedia.com')
        ...
        self.url        = "https://www.expedia.com/Cancun-Hotels-Seadust-Cancun-All-Inclusive-Family-Resort.h1579645.Hotel-Information"
    ...
    def dowload_csv(self, data):
        ...
        return df.to_csv(f'csv_file/seadust-expediaCOM.csv',index = False, header=True)
